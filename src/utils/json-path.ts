export const orderJsonPathMap: Record<string, string> = {
  ...
  settlement_counterparty: '$.message.order.payment["@ondc/org/settlement_details"][*].settlement_counterparty',
  buyer_finder_fee_amount: '$.message.order.payment["@ondc/org/buyer_app_finder_fee_amount"]',
  buyer_finder_fee_type: '$.message.order.payment["@ondc/org/buyer_app_finder_fee_type"]',
